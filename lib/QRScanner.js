...
export class QRScannerRectView extends Component {
  ...
  static propTypes = {
    ...
    hintText: PropTypes.string | PropTypes.element, // 提示文字
  ...
  render() {
    ...
    return (
      <View style={[styles.container, { bottom: 0 }]}>
        ...
        {/*扫描框上方遮罩*/}
        <View style={[this.getBackgroundColor(), { height: this.innerRectStyle.marginTop, flex: this.innerRectStyle.marginTop > 0 ? 0 : 1 }]} />
        ...
        <View style={[this.getBackgroundColor(), { flex: 1, alignItems: 'center' }]}>
          {
            typeof this.props.hintText === 'string'
              ...
              : <View style={this.innerHintTextStyle}>{this.props.hintText}</View>
          }
        </View>
...
export default class QRScannerView extends Component {
  ...
  static propTypes = {
    ...
    hintText: PropTypes.string | PropTypes.element,
  ...
  componentWillUnmount() {
    ...
    this.rnCamera && this.cameraReady && this.rnCamera.pausePreview();
  }
  ...
  handleAppStateChange = (currentAppState) => {
    if (currentAppState !== 'active') {
      ...
      this.rnCamera && this.cameraReady && this.rnCamera.resumePreview();
    }
  };
